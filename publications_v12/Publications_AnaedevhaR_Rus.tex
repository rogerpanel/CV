...
\pubmeta{опубликована}{Scopus (Q3, Computer Science misc.), РИНЦ}{№6 (М7 -- единая система сертификации, базовая постановка состязательной устойчивости)}
...
Scopus (Q3, Computer Science misc.), РИНЦ --- журнальная статья & 1 & 14{,}3\% \\
