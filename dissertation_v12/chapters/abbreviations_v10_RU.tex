...
CT-TGNN & Темпоральная графовая нейронная сеть непрерывного времени (Модель М1) \\
...
FedLLM-API & Федеративная оптимизация графов с большими языковыми моделями и приватностью (Модель М2) \\
...
Стох.\ трансф. & Стохастический трансформер (Модель М5) \\
...
TripleE-TGNN & Темпоральная графовая нейронная сеть с тройным вложением для многоуровневых представлений (Модель М3) \\
UC-HGP & Иерархический гауссовский процесс с калиброванной неопределённостью (Модель М6) \\
\end{longtable}
