...
\emph{система} Hybrid~IDPS, формализованная в
...
\emph{(II)~адаптация системы Hybrid~IDPS к сектору БПЛА}
...
предварительная валидация системы Hybrid~IDPS на UAV-задачах в
качестве преамбулы~--- в \S\ref{sec:ch3_uav_preview}
