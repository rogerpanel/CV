...
% generated tables use table; IEEE two-column: let wide ones float across columns
% Generated tables use the `table' environment; in two-column layout the wide ones must span both columns.
\let\origtable\table\let\endorigtable\endtable
\newcommand{\wideon}{\renewenvironment{table}{\begin{table*}[!t]}{\end{table*}}}
\newcommand{\wideoff}{\renewenvironment{table}{\begin{origtable}[!t]}{\end{origtable}}}
\begin{document}
...
\wideon\input{tables/e1_auroc_inflation}\wideoff
\wideon\input{tables/e1_auroc_inflation_subject}\wideoff
\begin{figure*}[!t]\centering\includegraphics[width=\textwidth]{e1_inflation_auroc.pdf}
...
\wideon\input{tables/e7_permutation}\wideoff
\input{e7_paragraph}
\input{tables/e8_reidentification}
\input{e8_paragraph}
\wideon\input{tables/e9_rocket}\wideoff
\input{e9_paragraph}

\subsection{E2: external validation}
\wideon\input{tables/e2_external_validation}\wideoff
...
\begin{figure}[!t]\centering\includegraphics[width=\columnwidth]{e3_ece_slope_comparison.pdf}
...
\wideon\input{tables/e5_obf_transdiagnostic}\wideoff
...
\wideon\input{tables/sota_comparison}\wideoff
\begin{figure*}[!t]\centering\includegraphics[width=\textwidth]{part1_claims_vs_bands.pdf}
