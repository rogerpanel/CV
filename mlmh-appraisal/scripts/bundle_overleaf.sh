...
cp paper/integrated/part1_studies.csv paper/integrated/PART1_INSTRUCTIONS.md paper/integrated/cover_letter_AIIM.pdf paper/integrated/supplementary.pdf paper/integrated/title_page_AIIM.pdf "$TMP/"
