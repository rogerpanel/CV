...
{\large \textbf{Adversarially-Resilient Models and Algorithms
for Improving the Robustness and Efficiency of Hybrid
Intrusion Detection and Prevention Systems in Distributed
...
the number of protocols and sessions.
...
implementation acts from four organisations.
...
implementation acts from four organisations: Rosatom State
Corporation (95.7\%), Positive Technologies LLC (federated
learning for commercial IDPS), Google~Cloud~Platform (96.8\%
accuracy, 40\% cost reduction), and Suricata Open~Source~IDPS
(adaptive plug-in with concept drift adaptation).
...
\begin{enumerate}
\item \textit{Rosatom State Corporation:} nuclear-industry
infrastructure protection, 95.7\% detection accuracy
(implementation act received).
\item \textit{Positive Technologies LLC:} federated-learning
integration for heterogeneous commercial security products
(implementation act received).
\item \textit{Google~Cloud~Platform:} edge-computing security,
96.8\% accuracy, 40\% cost reduction (implementation act
received).
\item \textit{Suricata Open~Source~IDPS:} adaptive detection
methods as a plug-in software with concept-drift adaptation
(implementation act received).
\end{enumerate}
...
(``onboard~-- droneport~-- cloud''), and implementation acts
have been received from four organisations: Rosatom (95.7\%),
Positive Technologies (federated learning), GCP (96.8\%,
$-$40\% cost), Suricata (drift adaptation).
\end{enumerate}
