...
implementation acts from three organisations: NII~IKT LLC
(critical-infrastructure network security, 95.7\%), Hexagon
LLC (federated learning for commercial Hybrid~IDPS and
edge-computing security, 96.8\% accuracy, 40\% cost reduction),
and the Artificial Intelligence Center of NRNU~MEPhI, Moscow
(deployment of AI-based Hybrid~IDPS to UAV onboard systems).
...
\begin{enumerate}
\item \textit{NII~IKT LLC:} critical-infrastructure network
security with the developed AI-based Hybrid~IDPS framework,
95.7\% detection accuracy (implementation act received).
\item \textit{Hexagon LLC:} federated-learning integration for
heterogeneous commercial Hybrid~IDPS deployments together with
edge-computing security, 96.8\% accuracy, 40\% cost reduction
...
have been received from three organisations: NII~IKT LLC
(critical-infrastructure network security, 95.7\%),
Hexagon LLC (federated commercial Hybrid~IDPS and
edge-computing, 96.8\%, $-$40\% cost), and the AI Center of
NRNU MEPhI, Moscow (UAV onboard deployment).
\end{enumerate}
