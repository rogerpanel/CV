...
% PPFOT-IDS (ours) - blue, solid
\addplot[color=blue!70!black, mark=*, mark size=2.5pt, thick] coordinates {
    (0.1, 85.7)
    (0.3, 89.2)
    (0.5, 91.8)
    (0.85, 94.2)
...
\addlegendentry{PPFOT-IDS (ours)}

% Private FedAvg - red, dashed
\addplot[color=red!70!black, mark=square*, mark size=2.2pt, dashed, thick] coordinates {
    (0.1, 68.9)
    (0.3, 74.5)
    (0.5, 77.8)
    (0.85, 82.3)
...
% DVACNN-Fed - orange, dash-dot
\addplot[color=orange!80!black, mark=triangle*, mark size=2.5pt, dashdotted, thick] coordinates {
    (0.1, 71.2)
    (0.3, 76.1)
    (0.5, 79.4)
    (0.85, 83.1)
...
\addlegendentry{DVACNN-Fed}

% FedAvg baseline (no explicit privacy) - horizontal dashed line
\addplot[color=gray!60!black, dotted, line width=1pt, forget plot] coordinates {
    (0.1, 78.3)
    (10.0, 78.3)
};
\node[anchor=south, font=\footnotesize, text=gray!60!black] at (axis cs:0.2,78.3) {FedAvg baseline};

% Vertical line at operating point ε=0.85
\addplot[color=green!60!black, densely dotted, line width=1pt, forget plot] coordinates {
    (0.85, 65)
    (0.85, 100)
};
\node[anchor=south, font=\footnotesize, text=green!60!black, rotate=90] at (axis cs:0.85,67) {Operating point $\epsilon=0.85$};
...
\begin{axis}[
    ...
    symbolic x coords={PPFOT-IDS, FedAvg, Private FedAvg, WDFT-DA},
    xtick=data,
...
\end{axis}
\end{tikzpicture}
\caption{Training time to convergence}
\end{subfigure}
\hfill
% (b) Inference Latency
\begin{subfigure}[b]{0.31\textwidth}
...
\begin{axis}[
    ...
    symbolic x coords={PPFOT-IDS, FedAvg, WDFT-DA},
    xtick=data,
    x tick label style={rotate=45, anchor=east, font=\scriptsize},
    ylabel style={font=\small},
    ymin=0, ymax=110,
...
% Real-time threshold at 100ms
\addplot[color=red!70!black, dashed, line width=1.2pt, forget plot] coordinates {
    (PPFOT-IDS, 100)
    (WDFT-DA, 100)
};
\node[anchor=west, font=\tiny, text=red!70!black] at (axis cs:FedAvg,100) {100ms threshold};
\end{axis}
\end{tikzpicture}
\caption{Per-sample inference latency}
\end{subfigure}
\hfill
