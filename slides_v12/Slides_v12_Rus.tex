...
\hl{разработка состязательных устойчивых моделей на основе
ИИ в Hybrid~IDPS для сетевой безопасности}~--- единое описание
Hybrid~IDPS и 7~AI-моделей с формальными гарантиями по
...
\begin{alertblock}{2 акта получены + 1 в стадии оформления}
\small ООО <<НИИ ИКТ>>~|~ООО <<Ксайрикс>>~|~Центр ИИ НИЯУ МИФИ
\end{alertblock}
\end{columns}
\end{frame}
...
\end{alertblock}
\smallskip
\textbf{Внедрение в промышленности:} получены 2 акта~--- ООО
<<НИИ ИКТ>> (г.~Новосибирск) и ООО <<Ксайрикс>> (г.~Москва); акт от
Центра искусственного интеллекта НИЯУ МИФИ, г.~Москва, находится в
стадии оформления.
\end{frame}
...
\column{0.50\textwidth}
\small
\textbf{Внедрение: 2 акта получены, 1 в стадии оформления}
\begin{enumerate}\setlength\itemsep{0pt}
\item \gd{ООО <<НИИ ИКТ>>} (г.~Новосибирск)~--- поглощение
устойчивых к отравлению моделей в действующую СОВ;
RobustIDPS.ai активно используется
\item \gd{ООО <<Ксайрикс>>} (г.~Москва)~--- анализ сетевого
трафика, графовое выявление многостадийных атак, оценки
неопределённости, адаптация к дрейфу
\item \bn{Центр ИИ НИЯУ МИФИ, г.~Москва}~--- применение
AI-моделей Hybrid~IDPS к защите бортовых систем БПЛА
\emph{(акт в стадии оформления)}
\end{enumerate}
\smallskip
\begin{alertblock}{}
