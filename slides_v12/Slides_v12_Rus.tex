...
\begin{alertblock}{3 акта внедрения}
\small ООО <<НИИ ИКТ>>~|~ООО <<Гексагон>>~|~Центр ИИ НИЯУ МИФИ
\end{alertblock}
\end{columns}
\end{frame}
...
\end{alertblock}
\smallskip
\textbf{3 акта внедрения в промышленности:} ООО <<НИИ ИКТ>>,
ООО <<Гексагон>>, Центр искусственного интеллекта НИЯУ МИФИ,
г.~Москва.
\end{frame}
...
\column{0.50\textwidth}
\small
\textbf{Акты внедрения (3 организации):}
\begin{enumerate}\setlength\itemsep{0pt}
\item \bn{ООО <<НИИ ИКТ>>}~--- защита сетевой безопасности
критической инфраструктуры (95,7\%)
\item \bn{ООО <<Гексагон>>}~--- федеративное обучение для
коммерческих Hybrid~IDPS и периферия (96,8\%, $-$40\% затрат)
