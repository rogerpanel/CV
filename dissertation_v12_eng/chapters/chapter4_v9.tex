...
Six benchmark datasets (CIC-IoT-2023, CSE-CICIDS2018, UNSW-NB15, Microsoft GUIDE, Container Security, Edge-IIoT) are used, totalling 84.2~million labelled samples and 84 attack types and spanning IoT networks, enterprise, hybrid, cloud, container, and edge/industrial environments. Detailed descriptions of each dataset and of the preprocessing pipeline are provided in Chapter~\ref{ch:adaptation}.
...
Software-implementation details (PyTorch~2.1, AdamW, hardware configurations) are provided in~\S\ref{sec:tech_stack_ui} of Chapter~\ref{ch:adaptation}.
