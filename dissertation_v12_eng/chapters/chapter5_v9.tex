...
(\S\ref{sec:platform_comparison}--\S\ref{sec:opensource}). At
least six screenshots of the system's user interface are included
to illustrate its operational capabilities.
...
%% [REMOVED: section "Platform Overview and Target Users" — platform internals (now in Chapter 3)]


%% [REMOVED: section "System Architecture" — platform internals (now in Chapter 3)]
...
%% [REMOVED: section "AI Command Centre" — platform internals (now in Chapter 3)]


%% [REMOVED: section "Detection Models" — platform internals (now in Chapter 3)]


%% [REMOVED: section "SOC Intelligence Suite" — platform internals (now in Chapter 3)]


%% [REMOVED: section "LLM Security Testing" — platform internals (now in Chapter 3)]


%% [REMOVED: section "MLSecOps Standards Compliance" — platform internals (now in Chapter 3)]


%% [REMOVED: section "Multi-Agent PQC-IDS Module" — platform internals (now in Chapter 3)]
...
%% [REMOVED: section "Operational Deployment Infrastructure" — platform internals (now in Chapter 3)]
...
\paragraph{Bridge with the above.}
Sections~\ref{ch:platform}--\ref{sec:deployment} above
...
All 17 models are validated on the CIC-IoT-2023 benchmark (Table~\ref{ch:platform}). The SurrogateIDS ensemble achieves the highest accuracy (97.8\%) through its seven-branch architecture. MambaShield delivers competitive accuracy (95.9\%) at the lowest latency (0.5\,ms).
