...
CyberSecLLM~\cite{Anaedevha2026cybersecllm}               & 97.1 97.1\% & 0.965 & 0.025 & 6.8\,ms \\
...
The Multi-Agent Post-Quantum Cryptography IDS module~\cite{Anaedevha2026mapqc,NIST2024} represents the forward-compatible detection capability of Model M4 (MambaShield) extended to post-quantum protocol environments. Four specialised agents collaborate through attention-weighted fusion:
...
Sections~\ref{sec:platform_overview}--\ref{sec:deployment} above
