...
%%=====================================================================
>>>>>>> 28891ca3fdb2051a91911334e6adc5a547c387c5
...
GNNs are deployed in healthcare, finance, cybersecurity, industrial, and autonomous systems~\cite{Goodfellow2014gan,Gilmer2017,Gilmer2018,Ying2021,Wu2021,Luo2021}, underscoring the urgency of robustness analysis.
...
Structured state-space models S4~\cite{Gu2022} reformulate sequential processing as a linear dynamical system with an $\mathcal{O}(L\log L)$ convolutional kernel via the FFT; the selective Mamba variant~\cite{Dao2024} adds input-dependent gating. GraphMamba~\cite{Behrouz2024graphmamba} began applying these to graph data, but their robustness to targeted perturbations and their capacity for reliable confidence estimates have not been investigated. Theoretical foundations include HiPPO~\cite{Gu2020hippo} and the unified analysis of linear recurrent architectures~\cite{Orvieto2023}; alternatives include Hyena operators~\cite{Poli2023} and random-feature attention~\cite{Choromanski2021,Perez2021}; the patch-tokenisation paradigm of vision transformers~\cite{Dosovitskiy2021,Salvi2024} was subsequently adapted to graph sequences.
...
Bayesian neural networks produce posterior predictive distributions with epistemic--aleatoric decomposition~\cite{Gal2016,Blundell2015,Lakshminarayanan2017,Kendall2017,Depeweg2018}; variational inference enables uncertainty estimates via MC dropout or ensembles. However, integration of variational Bayesian attention with hierarchical Gaussian-process uncertainty for graph-structured online adaptation has not been achieved, and most methods degrade significantly under distribution shift~\cite{Ovadia2019,Dusenberry2020,Foong2019,Kuleshov2018}. A Bayesian approach to adaptive ANN architecture selection, closely related to the uncertainty-regularised scheme proposed here, has been developed by the scientific supervisor~--- A.\,G.\,Trofimov and V.\,I.\,Skrugin~\cite{Trofimov2019bayes}; the classical Russian foundations of pattern-recognition theory and intelligent systems are represented by Yu.\,I.\,Zhuravlev's algebraic approach~\cite{Zhuravlev1977} and D.\,A.\,Pospelov's works on reasoning modelling~\cite{Pospelov1989}.
